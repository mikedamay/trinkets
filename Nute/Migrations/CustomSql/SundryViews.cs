...
/*
    ...
    1. drop all objects from database (but leave the "nutrition" database itself
    ...
    1. execute "dotnet ef migrations add --context NutritionDbContext <something>" - to generate migrations from model
    2. execute "dotnet ef database update --context NutritionDbContext"
