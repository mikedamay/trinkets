...
var showNext = function() {
    try
    {
        ...
        speuappdev_heatMapEngine_ns.drawHeatMap(DataChoices[lstDataSets.value].slice(0,counter), makeParams());
    }
    catch (ex) {
        alert(ex);
    }
...
try
{
    ...
    speuappdev_heatMapEngine_ns.drawHeatMap(DataChoices[lstDataSets.value], makeParams());
}
catch (ex) {
    alert(ex);
}
